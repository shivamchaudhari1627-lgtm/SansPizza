...
export const menuItems: MenuItem[] = [
  ...
  // --- Drinks ---
  { id: 'd1', name: 'Coca-Cola', description: 'Chilled 500ml bottle.', price: 1.99, image: 'https://picsum.photos/seed/cola/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd2', name: 'Pepsi', description: 'Chilled 500ml bottle.', price: 1.99, image: 'https://picsum.photos/seed/pepsi/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd3', name: 'Sprite', description: 'Chilled 500ml bottle.', price: 1.99, image: 'https://picsum.photos/seed/sprite/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd4', name: 'Fanta', description: 'Chilled 500ml bottle.', price: 1.99, image: 'https://picsum.photos/seed/fanta/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd5', name: 'Orange Juice', description: 'Freshly squeezed orange juice.', price: 3.99, image: 'https://picsum.photos/seed/orangejuice/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd6', name: 'Mango Juice', description: 'Rich and thick mango refresher.', price: 3.99, image: 'https://picsum.photos/seed/mangojuice/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd7', name: 'Lemonade', description: 'Sweet and sour classic lemonade.', price: 2.99, image: 'https://picsum.photos/seed/lemonade/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd8', name: 'Iced Tea', description: 'Peach flavored iced tea.', price: 2.99, image: 'https://picsum.photos/seed/icedtea/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd9', name: 'Cold Coffee', description: 'Creamy blended cold coffee.', price: 4.99, image: 'https://picsum.photos/seed/coldcoffee/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd10', name: 'Chocolate Shake', description: 'Thick chocolate milkshake.', price: 5.99, image: 'https://picsum.photos/seed/chocoshake/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd11', name: 'Strawberry Shake', description: 'Fresh strawberry milkshake.', price: 5.99, image: 'https://picsum.photos/seed/strawberryshake/500/500', category: 'Drinks', type: 'veg' },
  { id: 'd12', name: 'Oreo Shake', description: 'Crunchy Oreo blended milkshake.', price: 6.49, image: 'https://picsum.photos/seed/oreoshake/500/500', category: 'Drinks', type: 'veg' },

  // --- Ice Creams ---
  { id: 'ic1', name: 'Vanilla Ice Cream', description: 'Classic vanilla bean scoop.', price: 2.99, image: 'https://picsum.photos/seed/vanillaicecream/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic2', name: 'Chocolate Ice Cream', description: 'Rich dark chocolate scoop.', price: 3.49, image: 'https://picsum.photos/seed/chocoicecream/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic3', name: 'Strawberry Ice Cream', description: 'Made with real strawberries.', price: 3.49, image: 'https://picsum.photos/seed/strawberryicecream/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic4', name: 'Butterscotch Ice Cream', description: 'Caramelized nuts in creamy butterscotch.', price: 3.99, image: 'https://picsum.photos/seed/butterscotch/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic5', name: 'Black Currant Ice Cream', description: 'Tangy and sweet black currant.', price: 3.99, image: 'https://picsum.photos/seed/blackcurrant/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic6', name: 'Belgian Chocolate', description: 'Premium Belgian chocolate chunks.', price: 4.49, image: 'https://picsum.photos/seed/belgianchoco/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic7', name: 'Cookies and Cream', description: 'Vanilla ice cream loaded with cookie bits.', price: 4.49, image: 'https://picsum.photos/seed/cookiescream/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic8', name: 'Ice Cream Sundae', description: 'Mixed scoops with chocolate syrup and nuts.', price: 6.99, image: 'https://picsum.photos/seed/sundae/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic9', name: 'Chocolate Brownie with Ice Cream', description: 'Warm brownie topped with vanilla ice cream.', price: 7.99, image: 'https://picsum.photos/seed/brownieicecream/500/500', category: 'Ice Creams', type: 'veg' },
  { id: 'ic10', name: 'Waffle Cone Ice Cream', description: 'Your choice of scoop in a crispy waffle cone.', price: 4.99, image: 'https://picsum.photos/seed/wafflecone/500/500', category: 'Ice Creams', type: 'veg' },
];
